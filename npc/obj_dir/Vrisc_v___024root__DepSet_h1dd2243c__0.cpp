...
VL_INLINE_OPT void Vrisc_v___024root___sequent__TOP__0(Vrisc_v___024root* vlSelf) {
    ...
    if (vlSelf->rst_n) {
        ...
        vlSelf->risc_v__DOT__id_inst = vlSelf->inst;
    } else {
...
VL_INLINE_OPT void Vrisc_v___024root___combo__TOP__1(Vrisc_v___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vrisc_v__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vrisc_v___024root___combo__TOP__1\n"); );
    // Body
...
void Vrisc_v___024root___eval(Vrisc_v___024root* vlSelf) {
    ...
    Vrisc_v___024root___combo__TOP__1(vlSelf);
    // Final
