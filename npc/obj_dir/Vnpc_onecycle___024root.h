...
VL_MODULE(Vnpc_onecycle___024root) {
  public:
    ...
    struct {
        ...
        QData/*63:0*/ npc_onecycle__DOT____Vcellout__u_EX__mem_waddr_o;
        QData/*63:0*/ npc_onecycle__DOT____Vcellout__u_EX__mem_raddr_o;
        QData/*63:0*/ npc_onecycle__DOT____Vcellout__u_EX__mem_wdata_o;
