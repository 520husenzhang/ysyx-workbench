...
VL_ATTR_COLD void VALU___024root__trace_init_sub__TOP__0(VALU___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+125,"reg2_rdata_addr", false,-1, 4,0);
    tracep->declQuad(c+121,"reg1_rdata_wire", false,-1, 63,0);
    tracep->declQuad(c+126,"reg2_rdata_wire", false,-1, 63,0);
    tracep->declBit(c+2,"re1", false,-1);
    tracep->declBit(c+3,"re2", false,-1);
    tracep->declQuad(c+19,"if_pc", false,-1, 63,0);
    tracep->declBus(c+128,"if_inst", false,-1, 31,0);
    ...
    tracep->declBit(c+123,"reg_we_id", false,-1);
    tracep->declBus(c+124,"reg_waddr_id", false,-1, 4,0);
    ...
    tracep->declQuad(c+121,"reg1_rdata_i", false,-1, 63,0);
    tracep->declQuad(c+126,"reg2_rdata_i", false,-1, 63,0);
    tracep->declBus(c+1,"reg1_raddr_o", false,-1, 4,0);
    tracep->declBus(c+125,"reg2_raddr_o", false,-1, 4,0);
    ...
    tracep->declBit(c+123,"reg_we_o", false,-1);
    tracep->declBus(c+124,"reg_waddr_o", false,-1, 4,0);
    ...
    tracep->declBus(c+54,"addr", false,-1, 5,0);
    ...
    tracep->declQuad(c+121,"rdata1", false,-1, 63,0);
    tracep->declBit(c+3,"re2", false,-1);
    tracep->declBus(c+125,"raddr2", false,-1, 4,0);
    tracep->declQuad(c+126,"rdata2", false,-1, 63,0);
    for (int i = 0; i < 32; ++i) {
...
VL_ATTR_COLD void VALU___024root__trace_full_sub_0(VALU___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->fullCData(oldp+54,((0x3fU & (IData)(vlSelf->risc_v__DOT__inst_IF__DOT__PC))),6);
    tracep->fullQData(oldp+55,(vlSelf->risc_v__DOT__inst_REG_files__DOT__regs[0]),64);
    tracep->fullQData(oldp+57,(vlSelf->risc_v__DOT__inst_REG_files__DOT__regs[1]),64);
    tracep->fullQData(oldp+59,(vlSelf->risc_v__DOT__inst_REG_files__DOT__regs[2]),64);
    tracep->fullQData(oldp+61,(vlSelf->risc_v__DOT__inst_REG_files__DOT__regs[3]),64);
    tracep->fullQData(oldp+63,(vlSelf->risc_v__DOT__inst_REG_files__DOT__regs[4]),64);
    tracep->fullQData(oldp+65,(vlSelf->risc_v__DOT__inst_REG_files__DOT__regs[5]),64);
    tracep->fullQData(oldp+67,(vlSelf->risc_v__DOT__inst_REG_files__DOT__regs[6]),64);
    tracep->fullQData(oldp+69,(vlSelf->risc_v__DOT__inst_REG_files__DOT__regs[7]),64);
    tracep->fullQData(oldp+71,(vlSelf->risc_v__DOT__inst_REG_files__DOT__regs[8]),64);
    tracep->fullQData(oldp+73,(vlSelf->risc_v__DOT__inst_REG_files__DOT__regs[9]),64);
    tracep->fullQData(oldp+75,(vlSelf->risc_v__DOT__inst_REG_files__DOT__regs[10]),64);
    tracep->fullQData(oldp+77,(vlSelf->risc_v__DOT__inst_REG_files__DOT__regs[11]),64);
    tracep->fullQData(oldp+79,(vlSelf->risc_v__DOT__inst_REG_files__DOT__regs[12]),64);
    tracep->fullQData(oldp+81,(vlSelf->risc_v__DOT__inst_REG_files__DOT__regs[13]),64);
    tracep->fullQData(oldp+83,(vlSelf->risc_v__DOT__inst_REG_files__DOT__regs[14]),64);
    tracep->fullQData(oldp+85,(vlSelf->risc_v__DOT__inst_REG_files__DOT__regs[15]),64);
    tracep->fullQData(oldp+87,(vlSelf->risc_v__DOT__inst_REG_files__DOT__regs[16]),64);
    tracep->fullQData(oldp+89,(vlSelf->risc_v__DOT__inst_REG_files__DOT__regs[17]),64);
    tracep->fullQData(oldp+91,(vlSelf->risc_v__DOT__inst_REG_files__DOT__regs[18]),64);
    tracep->fullQData(oldp+93,(vlSelf->risc_v__DOT__inst_REG_files__DOT__regs[19]),64);
    tracep->fullQData(oldp+95,(vlSelf->risc_v__DOT__inst_REG_files__DOT__regs[20]),64);
    tracep->fullQData(oldp+97,(vlSelf->risc_v__DOT__inst_REG_files__DOT__regs[21]),64);
    tracep->fullQData(oldp+99,(vlSelf->risc_v__DOT__inst_REG_files__DOT__regs[22]),64);
    tracep->fullQData(oldp+101,(vlSelf->risc_v__DOT__inst_REG_files__DOT__regs[23]),64);
    tracep->fullQData(oldp+103,(vlSelf->risc_v__DOT__inst_REG_files__DOT__regs[24]),64);
    tracep->fullQData(oldp+105,(vlSelf->risc_v__DOT__inst_REG_files__DOT__regs[25]),64);
    tracep->fullQData(oldp+107,(vlSelf->risc_v__DOT__inst_REG_files__DOT__regs[26]),64);
    tracep->fullQData(oldp+109,(vlSelf->risc_v__DOT__inst_REG_files__DOT__regs[27]),64);
    tracep->fullQData(oldp+111,(vlSelf->risc_v__DOT__inst_REG_files__DOT__regs[28]),64);
    tracep->fullQData(oldp+113,(vlSelf->risc_v__DOT__inst_REG_files__DOT__regs[29]),64);
    tracep->fullQData(oldp+115,(vlSelf->risc_v__DOT__inst_REG_files__DOT__regs[30]),64);
    tracep->fullQData(oldp+117,(vlSelf->risc_v__DOT__inst_REG_files__DOT__regs[31]),64);
    tracep->fullBit(oldp+119,(vlSelf->clk));
    tracep->fullBit(oldp+120,(vlSelf->rst_n));
    tracep->fullQData(oldp+121,(((IData)(vlSelf->rst_n)
                                      ...
                                      ? 0ULL : (((((IData)(vlSelf->risc_v__DOT__reg1_rdata_addr) 
                                                ...
                                                ((IData)(vlSelf->risc_v__DOT__re1)
                                                 ...
                                                 [vlSelf->risc_v__DOT__reg1_rdata_addr]
                                                  : 0ULL)))
                                  : 0ULL)),64);
    tracep->fullBit(oldp+123,(((IData)(vlSelf->rst_n) 
                               & (IData)((0x13U == 
                                          (0x707fU 
                                           & vlSelf->risc_v__DOT__id_inst))))));
    tracep->fullCData(oldp+124,(((IData)(vlSelf->rst_n)
                                  ? ((0x13U == (0x7fU 
                                                & vlSelf->risc_v__DOT__id_inst))
                                      ? ((0U == (7U 
                                                 & (vlSelf->risc_v__DOT__id_inst 
                                          ...
                                          : 0U) : 0U)
                                  : 0U)),5);
    tracep->fullCData(oldp+125,(0U),5);
    tracep->fullQData(oldp+126,(0ULL),64);
    tracep->fullIData(oldp+128,(vlSelf->risc_v__DOT__if_inst),32);
}
