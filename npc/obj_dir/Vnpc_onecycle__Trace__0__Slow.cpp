...
VL_ATTR_COLD void Vnpc_onecycle___024root__trace_init_sub__TOP__0(Vnpc_onecycle___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declQuad(c+211,"pc_IF_ID", false,-1, 63,0);
    ...
    tracep->declBus(c+213,"wd_EX_GEN_REGS", false,-1, 4,0);
    tracep->declBit(c+214,"wreg_EX_GEN_REGS", false,-1);
    tracep->declQuad(c+215,"wdata_EX_GEN_REGS", false,-1, 63,0);
    ...
    tracep->declBit(c+217,"csr_read_ID_CSR_REGS", false,-1);
    ...
    tracep->declQuad(c+211,"inst_addr_ID_EX", false,-1, 63,0);
    ...
    tracep->declQuad(c+218,"csr_rdata_ID_EX", false,-1, 63,0);
    ...
    tracep->declQuad(c+39,"csr_waddr_EX_MEM", false,-1, 63,0);
    ...
    tracep->declBit(c+217,"read_en_i", false,-1);
    tracep->declBit(c+220,"clint_we_i", false,-1);
    tracep->declQuad(c+221,"clint_waddr_i", false,-1, 63,0);
    tracep->declQuad(c+223,"clint_wdata_i", false,-1, 63,0);
    tracep->declQuad(c+225,"clint_raddr_i", false,-1, 63,0);
    ...
    tracep->declQuad(c+211,"inst_addr_i", false,-1, 63,0);
    ...
    tracep->declQuad(c+218,"csr_rdata_i", false,-1, 63,0);
    tracep->declQuad(c+227,"int_addr_i", false,-1, 63,0);
    tracep->declBit(c+229,"int_assert_i", false,-1);
    ...
    tracep->declBit(c+230,"hold_flag_o", false,-1);
    ...
    tracep->declArray(c+231,"op1_op2_mul", false,-1, 127,0);
    ...
    tracep->declBit(c+235,"hold_symbol", false,-1);
    tracep->declBit(c+236,"jump_symbol", false,-1);
    ...
    tracep->declBus(c+237,"inst_ex_i", false,-1, 31,0);
    tracep->declQuad(c+238,"ex_wdata_i", false,-1, 63,0);
    tracep->declBus(c+240,"ex_wd_i", false,-1, 4,0);
    tracep->declBit(c+241,"ex_wreg_i", false,-1);
    tracep->declQuad(c+242,"mem_wdata_reg_i", false,-1, 63,0);
    tracep->declBus(c+244,"mem_wd_reg_i", false,-1, 4,0);
    tracep->declBit(c+245,"mem_wreg_i", false,-1);
    ...
    tracep->declBit(c+217,"csr_read_o", false,-1);
    tracep->declBus(c+176,"inst_o", false,-1, 31,0);
    tracep->declQuad(c+211,"inst_addr_o", false,-1, 63,0);
    ...
    tracep->declQuad(c+218,"csr_rdata_o", false,-1, 63,0);
    ...
    tracep->declBit(c+174,"clk", false,-1);
    tracep->declBit(c+175,"rst_n", false,-1);
    tracep->declBus(c+247,"hold_flag_i", false,-1, 5,0);
...
VL_ATTR_COLD void Vnpc_onecycle___024root__trace_full_sub_0(Vnpc_onecycle___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->fullSData(oldp+20,(vlSelf->npc_onecycle__DOT____Vcellout__u_EX__csr_waddr_o),12);
    ...
    tracep->fullQData(oldp+39,((QData)((IData)(vlSelf->npc_onecycle__DOT____Vcellout__u_EX__csr_waddr_o))),64);
    ...
    tracep->fullQData(oldp+190,(((((IData)(vlSelf->npc_onecycle__DOT____Vcellout__u_EX__csr_waddr_o) 
    ...
    tracep->fullQData(oldp+211,(vlSelf->npc_onecycle__DOT__pc_IF_ID),64);
    tracep->fullCData(oldp+213,(vlSelf->npc_onecycle__DOT__wd_EX_GEN_REGS),5);
    tracep->fullBit(oldp+214,(vlSelf->npc_onecycle__DOT__wreg_EX_GEN_REGS));
    tracep->fullQData(oldp+215,(vlSelf->npc_onecycle__DOT__wdata_EX_GEN_REGS),64);
    tracep->fullBit(oldp+217,(vlSelf->npc_onecycle__DOT__csr_read_ID_CSR_REGS));
    tracep->fullQData(oldp+218,(vlSelf->npc_onecycle__DOT__csr_rdata_ID_EX),64);
    tracep->fullBit(oldp+220,(vlSelf->npc_onecycle__DOT__u_CSR_REGS__DOT__clint_we_i));
    tracep->fullQData(oldp+221,(vlSelf->npc_onecycle__DOT__u_CSR_REGS__DOT__clint_waddr_i),64);
    tracep->fullQData(oldp+223,(vlSelf->npc_onecycle__DOT__u_CSR_REGS__DOT__clint_wdata_i),64);
    tracep->fullQData(oldp+225,(vlSelf->npc_onecycle__DOT__u_CSR_REGS__DOT__clint_raddr_i),64);
    tracep->fullQData(oldp+227,(vlSelf->npc_onecycle__DOT__u_EX__DOT__int_addr_i),64);
    tracep->fullBit(oldp+229,(vlSelf->npc_onecycle__DOT__u_EX__DOT__int_assert_i));
    tracep->fullBit(oldp+230,(vlSelf->npc_onecycle__DOT__u_EX__DOT__hold_flag_o));
    tracep->fullWData(oldp+231,(vlSelf->npc_onecycle__DOT__u_EX__DOT__op1_op2_mul),128);
    tracep->fullBit(oldp+235,(vlSelf->npc_onecycle__DOT__u_EX__DOT__hold_symbol));
    tracep->fullBit(oldp+236,(vlSelf->npc_onecycle__DOT__u_EX__DOT__jump_symbol));
    tracep->fullIData(oldp+237,(vlSelf->npc_onecycle__DOT__u_ID__DOT__inst_ex_i),32);
    tracep->fullQData(oldp+238,(vlSelf->npc_onecycle__DOT__u_ID__DOT__ex_wdata_i),64);
    tracep->fullCData(oldp+240,(vlSelf->npc_onecycle__DOT__u_ID__DOT__ex_wd_i),5);
    tracep->fullBit(oldp+241,(vlSelf->npc_onecycle__DOT__u_ID__DOT__ex_wreg_i));
    tracep->fullQData(oldp+242,(vlSelf->npc_onecycle__DOT__u_ID__DOT__mem_wdata_reg_i),64);
    tracep->fullCData(oldp+244,(vlSelf->npc_onecycle__DOT__u_ID__DOT__mem_wd_reg_i),5);
    tracep->fullBit(oldp+245,(vlSelf->npc_onecycle__DOT__u_ID__DOT__mem_wreg_i));
    tracep->fullBit(oldp+246,(vlSelf->npc_onecycle__DOT__u_ID__DOT__hold_flag_o));
    tracep->fullCData(oldp+247,(vlSelf->npc_onecycle__DOT__u_IF__DOT__hold_flag_i),6);
    tracep->fullBit(oldp+248,(vlSelf->npc_onecycle__DOT__u_IF__DOT__hold_flag_o));
    tracep->fullBit(oldp+249,(vlSelf->npc_onecycle__DOT__u_MEM__DOT__hold_flag_o));
}
