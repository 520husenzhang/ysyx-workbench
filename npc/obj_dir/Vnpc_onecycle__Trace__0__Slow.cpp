...
VL_ATTR_COLD void Vnpc_onecycle___024root__trace_init_sub__TOP__0(Vnpc_onecycle___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+220,"pc_IF_ID", false,-1);
    ...
    tracep->declBit(c+221,"clint_we_i", false,-1);
    tracep->declQuad(c+222,"clint_waddr_i", false,-1, 63,0);
    tracep->declQuad(c+224,"clint_wdata_i", false,-1, 63,0);
    tracep->declQuad(c+226,"clint_raddr_i", false,-1, 63,0);
    ...
    tracep->declQuad(c+228,"int_addr_i", false,-1, 63,0);
    tracep->declBit(c+230,"int_assert_i", false,-1);
    ...
    tracep->declBit(c+231,"hold_flag_o", false,-1);
    ...
    tracep->declArray(c+232,"op1_op2_mul", false,-1, 127,0);
    ...
    tracep->declBit(c+236,"hold_symbol", false,-1);
    tracep->declBit(c+237,"jump_symbol", false,-1);
    ...
    tracep->declBus(c+238,"inst_ex_i", false,-1, 31,0);
    tracep->declQuad(c+239,"ex_wdata_i", false,-1, 63,0);
    tracep->declBus(c+241,"ex_wd_i", false,-1, 4,0);
    tracep->declBit(c+242,"ex_wreg_i", false,-1);
    tracep->declQuad(c+243,"mem_wdata_reg_i", false,-1, 63,0);
    tracep->declBus(c+245,"mem_wd_reg_i", false,-1, 4,0);
    tracep->declBit(c+246,"mem_wreg_i", false,-1);
    ...
    tracep->declBit(c+174,"clk", false,-1);
    tracep->declBit(c+175,"rst_n", false,-1);
    tracep->declBus(c+248,"hold_flag_i", false,-1, 5,0);
...
VL_ATTR_COLD void Vnpc_onecycle___024root__trace_full_sub_0(Vnpc_onecycle___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->fullQData(oldp+216,((QData)((IData)(vlSelf->npc_onecycle__DOT__pc_IF_ID))),64);
    tracep->fullQData(oldp+218,(vlSelf->npc_onecycle__DOT__csr_rdata_ID_EX),64);
    tracep->fullBit(oldp+220,(vlSelf->npc_onecycle__DOT__pc_IF_ID));
    tracep->fullBit(oldp+221,(vlSelf->npc_onecycle__DOT__u_CSR_REGS__DOT__clint_we_i));
    tracep->fullQData(oldp+222,(vlSelf->npc_onecycle__DOT__u_CSR_REGS__DOT__clint_waddr_i),64);
    tracep->fullQData(oldp+224,(vlSelf->npc_onecycle__DOT__u_CSR_REGS__DOT__clint_wdata_i),64);
    tracep->fullQData(oldp+226,(vlSelf->npc_onecycle__DOT__u_CSR_REGS__DOT__clint_raddr_i),64);
    tracep->fullQData(oldp+228,(vlSelf->npc_onecycle__DOT__u_EX__DOT__int_addr_i),64);
    tracep->fullBit(oldp+230,(vlSelf->npc_onecycle__DOT__u_EX__DOT__int_assert_i));
    tracep->fullBit(oldp+231,(vlSelf->npc_onecycle__DOT__u_EX__DOT__hold_flag_o));
    tracep->fullWData(oldp+232,(vlSelf->npc_onecycle__DOT__u_EX__DOT__op1_op2_mul),128);
    tracep->fullBit(oldp+236,(vlSelf->npc_onecycle__DOT__u_EX__DOT__hold_symbol));
    tracep->fullBit(oldp+237,(vlSelf->npc_onecycle__DOT__u_EX__DOT__jump_symbol));
    tracep->fullIData(oldp+238,(vlSelf->npc_onecycle__DOT__u_ID__DOT__inst_ex_i),32);
    tracep->fullQData(oldp+239,(vlSelf->npc_onecycle__DOT__u_ID__DOT__ex_wdata_i),64);
    tracep->fullCData(oldp+241,(vlSelf->npc_onecycle__DOT__u_ID__DOT__ex_wd_i),5);
    tracep->fullBit(oldp+242,(vlSelf->npc_onecycle__DOT__u_ID__DOT__ex_wreg_i));
    tracep->fullQData(oldp+243,(vlSelf->npc_onecycle__DOT__u_ID__DOT__mem_wdata_reg_i),64);
    tracep->fullCData(oldp+245,(vlSelf->npc_onecycle__DOT__u_ID__DOT__mem_wd_reg_i),5);
    tracep->fullBit(oldp+246,(vlSelf->npc_onecycle__DOT__u_ID__DOT__mem_wreg_i));
    tracep->fullBit(oldp+247,(vlSelf->npc_onecycle__DOT__u_ID__DOT__hold_flag_o));
    tracep->fullCData(oldp+248,(vlSelf->npc_onecycle__DOT__u_IF__DOT__hold_flag_i),6);
    tracep->fullBit(oldp+249,(vlSelf->npc_onecycle__DOT__u_IF__DOT__hold_flag_o));
    tracep->fullBit(oldp+250,(vlSelf->npc_onecycle__DOT__u_MEM__DOT__hold_flag_o));
}
